        ...
        http
            ...
            .exceptionHandling(exceptions -> exceptions
                .authenticationEntryPoint((request, response, authException) -> {
                    ...
                    response.getWriter().write("{\"message\":\"Unauthorized: " + authException.getMessage() + "\",\"statusCode\":401,\"code\":\"UNAUTHORIZED\"}");
                })
            )
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/goals/**").permitAll()
